				       ...
				       const void *data, int data_len)
{
	...
	flq_log("register csi_portid%u", mvm->csi_portid) ;
...
{
	flq_dbge("set iwl_mvm_vendor_commands, NL80211_CMD_VENDOR=%d", 
			NL80211_CMD_VENDOR) ;
		       ...
		       void **data, unsigned int *len)
{
	...
	flqn_dbgi(10000, "csi_portid=%d hdr_len=%u (0 is unregister)", 
...
static void iwl_mvm_csi_complete(struct iwl_mvm *mvm)
{
	...
	flqn_dbge(10000, "csi_portid=%d", mvm->csi_portid) ;
