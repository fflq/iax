...
function s = gs()
    ...
    g.envs.subc_idxs = -500:1:500 ;
    g.envs.subc_idxs = -58:4:58 ;
    g.envs.ntone = length(g.envs.subc_idxs) ;
    %g.envs.nsubc = length(g.envs.subc_idxs) ;
    %g.envs.nsubc_smooth = floor(g.envs.nsubc/2) ;
    g.envs.ntone_sm = floor(g.envs.ntone/2) ;
    g.envs.nant_sm = floor(g.envs.nant_rx/2)+1 ;
