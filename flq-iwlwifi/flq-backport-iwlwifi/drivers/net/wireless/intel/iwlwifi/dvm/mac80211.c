...
//fflqb_csi
static int flq_iwlagn_mac_conf_tx(struct ieee80211_hw *hw,
			       struct ieee80211_vif *vif,
			       unsigned int link_id, u16 ac,
			       const struct ieee80211_tx_queue_params *params)
{
	return iwlagn_mac_conf_tx(hw, vif, ac, params);
}

void flq_iwlagn_bss_info_changed(struct ieee80211_hw *hw,
				     struct ieee80211_vif *vif,
				     struct ieee80211_bss_conf *bss_conf,
				     u64 changes)
{
	iwlagn_bss_info_changed(hw, vif, bss_conf, (u32)changes);
}
//fflqe_csi
...
const struct ieee80211_ops iwlagn_hw_ops = {
	...
	.conf_tx = flq_iwlagn_mac_conf_tx,
	.bss_info_changed = flq_iwlagn_bss_info_changed,
	//fflqe_csi
