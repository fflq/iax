...
static std::map<uint32_t, std::string> g_rate_type_map = {
...
static std::map<uint32_t, std::string> g_he_type_map = {
...
static std::map<uint32_t, int> g_chan_width_map = {
...
typedef struct rate_info_t {
    ...
    int nss;
    int rate_type;
    const char *rate_type_str;
    int he_type = -1;
    const char *he_type_str = nullptr;
    int chan_width_type;
    int bandwidth;
    const char *rate_bw_type = nullptr;
    int ant_sel;
    int ldpc;
